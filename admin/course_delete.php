...
if (isset($_GET['id'])) {
    ...
    $checkSql = "SELECT * FROM `enquiry_course` WHERE course_id = $id";
    ...
    if ($profileExists) {
        ...
        echo "<script>
            if (confirm('Are you sure you want to delete this Enquiry?')) {
                window.location.href = 'course_delete.php?confirmedDelete=$id';
            } else {
    ...
    $sql = "DELETE FROM `enquiry_course` WHERE course_id = $id";
