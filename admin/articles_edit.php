...
$qryRes=mysqli_query($con,$edit_qry);
...
<h1 class="text-center" style="background-color:#ffcc99;">
    Edit Articles
</h1>
<div class="container-fluid pt-4 px-4" style="overflow-y:scroll; height:500px;">
            ...
            <form action="./actions/edit_article.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <input type="text" name="author_name" class="form-control" id="author_name" value="<?= $qryRow['art_author']?>">
                    </div>
                </div><br>
                <div class="col-md-10">
                    <div class="form-group">
                        <label for="img_alp" class="">Article Image</label>
                        <img src="<?= $qryRow['art_image']?>" alt="">
