            ...
            <nav class="navbar navbar-expand-lg main-nav px-0">
                ...
                <div class="collapse navbar-collapse" style="margin-left:5%;margin-top:30px;" id="mainMenu">
                    <ul class="navbar-nav ml-auto text-uppercase f1">
                        ...
                        <li>
                            <a href="https://forms.gle/o2u2Y18bfdqJvQ7r9"  class="nav_link" target="blank">Tamil Class Registration</a>
                        </li>
                        <li>
                            <a href="https://forms.gle/ULNKXxkD5UPyna249"  class="nav_link" target="blank">English Registration</a>
                        </li>
                        <!--<li>-->
