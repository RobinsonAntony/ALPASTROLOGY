            ...
            <nav class="navbar navbar-expand-lg main-nav px-0">
                ...
                <div class="collapse navbar-collapse" style="margin-left:5%;margin-top:30px;" id="mainMenu">
                    <ul class="navbar-nav ml-auto text-uppercase f1">
                        ...
                        <li>
                            <a href="courses"  class="nav_link">courses</a>
                        </li>
                        <li>
                            <a href="consultation"  class="nav_link">Consultation</a>
                        </li>
                        <li>
                            <a href="software"  class="nav_link">Software</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="faq"  class="nav_link">FAQs</a>
                        </li>
                        <li>
                             <a class="g_trans">
...
<script>
 ...
 <script type="text/javascript">
    ...
    <script src="https://analytics.ahrefs.com/analytics.js" data-key="WN9J3fPz85inoqhfJCT6qQ" async></script>
    
    <script>
  var ahrefs_analytics_script = document.createElement('script');
  ahrefs_analytics_script.async = true;
  ahrefs_analytics_script.src = 'https://analytics.ahrefs.com/analytics.js';
  ahrefs_analytics_script.setAttribute('data-key', 'WN9J3fPz85inoqhfJCT6qQ');
