    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 text-center">
                <h1 class="as_heading">Our Purpose:</h1>
                <h3 class="as_banner_detail"> Revolutionizing Astrological Consultation</h3>
                
                <p class="as_font14 as_padderTop20 as_padderBottom50 revealy">ALP Astrology is dedicated to empowering individuals by offering profound insights into their lives through the fusion of traditional astrology and modern psychological understanding. Our vision extends to a world where every household has ready access to a skilled ALP astrologer. In this envisioned future, astrology is consulted in an organized and structured manner, becoming an integral part of personal development, and allowing the wisdom of the Stars to elevate individuals to new levels of self-discovery and growth.</p>
            </div>
            <div class="col-lg-3 col-md-3">
                <div class="as_aboutimg text-right revealx">
                    <img src="assets/images/m-58.jpg" alt="" class="img-responsive">
                    <p></P>
            ...
            <div class="col-lg-9 col-md-9">
                <div class="as_about_detail">
                    ...
                    <div class="as_paragraph_wrapper">
                        <p class="as_margin0 as_font14 as_padderBottom10 revealy">We envision a world where astrology is highly respected and integral part of personal development, self-awareness, and decision-making. Our vision encompasses several key components:</p>
                    ...
                    <!--<div class="as_service_img revealx">-->
                    <div>
...
<!--<section class="as_service_wrapper as_padderTop80 as_padderBottom80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h1 class="as_heading as_heading_center">our courses</h1>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="as_service_box text-center">
                                    ...
                                    <a href="service_single.php" class="as_link">read more 
                                        <span>
...
<section class="as_customer_wrapper as_padderBottom40 as_padderTop40">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <!-- <h1 class="as_heading as_heading_center">What our ALP Astrology learners Say</h1> -->
                
                <!--<p class="as_font14 as_padderBottom50 as_padderTop20"> Students <br>Corner</p>-->

                <!-- <div class="row as_customer_slider">
                    <div class="col-lg-5 col-md-5 as_customer_nav">
                        <div class="as_customer_img">
                            <img src="assets/images/c2.png" alt="" class="img-responsive">
                        </div>
                        <div class="as_customer_img">
                            <img src="assets/images/c2.png" alt="" class="img-responsive">
                        </div>
                        <div class="as_customer_img">
                            <img src="assets/images/c3.png" alt="" class="img-responsive">
                        </div>
                        <div class="as_customer_img">
                            <img src="assets/images/c4.png" alt="" class="img-responsive">
                        </div>
                        <div class="as_customer_img">
                            <img src="assets/images/R1.JPEG" alt="" class="img-responsive">
                        </div>
                        <div class="as_customer_img">
                            <img src="assets/images/c6.png" alt="" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7 as_customer_for">
                        <div class="as_customer_box text-center">
                            <p class="as_margin0"><b>“Naga Suganya”</b></p>
                            <span>Im proud to be an ALP student, when I came to the class I have 0 knowledge about astrology, after 15 days of class we can definitely know how to predict the astrology. Our guruji MR. POTHUVUDAIMOORTHY and our teachers will teach us in the way the beginners will understand. It's a proper astrology institution with the rule and regulations. only the dedicated students can learn from our guruji, the dedication of our teachers is wonderful, u cannot see anywhere this much of oganized, well deciplined teachers, coaches and volunteers .MONEY IS NOT A BIG MATTER FOR OUR GURU, HIS MOTIVATION IS "VEETUKKU ORU JOTHIDAR".proud to be his student, THANKS GURUJI</span>
                        </div>
                        <div class="as_customer_box text-center">
                            <p class="as_margin0"><b>“Senthil Kumar Elavazhagan”</b></p>
                            <span>This is an awesome experience , Bringing astrology close to you and making you learn astrology in a very short span of time is remarkable. Its not just learning, he helps us predict and ensures our prediction is accurate. ALP Astrology Method is the best. Many thanks to Guruji PothuvudaiMoorthy sir.</span>
                        </div>
                        <div class="as_customer_box text-center">
                            <p class="as_margin0"><b>“Amutha Shanmugaraj”</b></p>
                            <span>I learned ALP astrology from Poduvudaimoorthy Sir. It's prediction is 100% true.I am a psychologist and psychotherapist. For counselling I am using Alp Astrology as scnning report. Actually It's a life Value added concept . It must be taught to every children in the school. It's simple to learn. Sir's prediction is 100% true. It help us to lead a life by accepting everything happened to us is because of our Karma done previously by us and do good Karma in this present. . Alp is life learning lessons . Thank you Sir.</span>
                        </div>
                        <div class="as_customer_box text-center">
                            <p class="as_margin0"><b>“Thejas Sundara”</b></p>
                            <span>Excellent teaching in early morning during Brammah muhoortham. Dr.S. Pothuvudaimoorthi Ayya himself taught 15 days class in simplest manner..We have to apply the rules and it works out like a miracle. We found the accuracy wherever we predict horoscope..All ALP astrologers are using this method and everyone prediction is uniform. No difference of opinions..Software is the Akshaya vessel and it feeds us present, past and future events.. At any point of time ALP astrologers fixing the date never changes. This is the whole strength of ALP Astrologers. We are so gratitude to the founder of ALP Dr.S.Pothuvudaimoorthi Ayya for sharpening us...</span>
                        </div>
                        <div class="as_customer_box text-center">
                            <p class="as_margin0"><b>“Dr. Senthil Kumaran”</b></p>
                            <span>My Experience with Akshaya Lagna Pathadi (ALP) Astrology I am writing to express my deepest gratitude for the incredible Akshaya Lagna Paddhati (ALP) Astrology training & its Great Inventor, Seer, Guru, Teacher, Professor, All in one Dr. S. PothuvudaiMoorthy Jothidar.  The journey through the intricacies of astrology has been nothing short of transformative, & I feel compelled to share my appreciation. <br/>
                            Thank you, Shri Podhuvudai Moorthy Sir, for being a beacon of knowledge and inspiration. Your dedication to the craft of astrology has left an indelible mark on my learning journey, and I am excited to continue exploring the depths of this ancient wisdom.
                        </span>
                        </div>
                        <div class="as_customer_box text-center">
                            <p class="as_margin0"><b>“Dr.R.sugantha”</b></p>
                            <span>Excellent structured curriculum,dedicated teachers .Without much effort the subject goes inside us naturally.I can say ALP as astrology for ALl LEVEL PEOPLE (ALP). No complicated calculation,we can get prediction with 100 persent accuracy provided the date of birth is correct. There is a unique way to find the given date of birth is correct. I recommend atleast one from each family should learn ALP astrology. They can guide their family each and every occasion .Thank you poothuvudai moorthy sir for a wonderful tool to the mankind .Blessed to learn the subject from the inventor directly</span>
                        </div>
                    </div>
                </div> -->
            </div>
